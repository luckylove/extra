// comparing the first occouring of any elements of the second array in the array first and
// return the elements that is comes first is far is the index was concerned
# include<stdio.h>
# include<string.h>
